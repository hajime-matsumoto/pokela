...
<?php $this->percial('au_program.php', array('name'=>"やりすぎソーサラー", 'head'=>'pf24','blog'=>$blog, 'cnt'=>2) ); ?>

<hr size="1">
<a name="pf11"></a> <font color="#FF9900"></font>『長谷優里奈のイソフラボン☆バ↑』<br>
<img src="img/pf11/ib.jpg" width="168" height="81"><br>
<?php $this->percial('au_program.php', array('name'=>"イソフラボンバー", 'head'=>'pf11','blog'=>$blog, 'cnt'=>2) ); ?>

<hr size="1">

<a name="pf05"></a> <font color="#FF9900"></font>『しろがねしょぉむと廣田詩夢のPower Voice Jam!』<br>
<img src="images/5.gif" width="80" height="50"><br>
<?php $this->percial('au_program.php', array('name'=>"パワーボイスジャム", 'head'=>'pf05','blog'=>$blog, 'cnt'=>2) ); ?>
...
<?php $this->percial('au_program.php', array('name'=>"トリラジ", 'head'=>'pf21','blog'=>$blog, 'cnt'=>2) ); ?>

<hr size="1">
<a name="pf_seiyuu"></a> <font color="#FF9900"></font>
<font color="#FF9900"></font>『30 DELUXとロック兄弟のＹＡＲＯＯ！』<br>
<img src="img/yaroo/main/logo.jpg" width="150"><br>
<?php $this->percial('au_program.php', array('name'=>"YAROO", 'head'=>'yaroo','blog'=>$blog, 'cnt'=>2) ); ?>

<hr size="1">
<a name="pf26"></a> <font color="#FF9900"></font>『めいち＆なっちの　もうDokuDoku』<br>
<img src="img/pf26/i_logo.jpg" width="150"><br>
<?php $this->percial('au_program.php', array('name'=>"ドクドク", 'head'=>'pf26','blog'=>$blog, 'cnt'=>1) ); ?>
