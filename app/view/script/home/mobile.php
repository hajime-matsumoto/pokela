...
<?php $this->percial('i_program.php', array('name'=>"魔界政府広報部", 'head'=>'makai','blog'=>$blog, 'cnt'=>1) ); ?>

<hr size="1">
<a name="vs"></a> <font color="#FF9900"></font>『V.S UNION WAVE』<br>
<img src="img/vs/main/top_banner.png" width="150"><br>
<?php $this->percial('i_program.php', array('name'=>"バーサスWAVE", 'head'=>'vs','blog'=>$blog, 'cnt'=>1) ); ?>
